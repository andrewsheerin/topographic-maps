...
| F-17 | Base thickness in print millimetres (was real-world metres) — consistent with the page's other units | fix | C | WIP | | User-directed unit change. Old 50 m default gave paper-thin bases at state scale (0.13 mm for RI). UI default 2 mm — user to confirm. |

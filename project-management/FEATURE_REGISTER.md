...
| --- | --- | --- | --- | --- | --- | --- |
| F-1 | Migrate to app-factory (L1): restructure into backend/ + frontend/, React rewrite, PM system | refactor | A | WIP | | Behaviour-preserving. Mark DONE with this migration's commit hash at wrap. |

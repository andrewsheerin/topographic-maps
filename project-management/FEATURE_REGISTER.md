...
| F-19 | Crop the mesh to the area boundary (state-shaped prints); STL always sealed — "Add base" checkbox removed | feature | C | WIP | | Slicer can't slice the no-base open sheet; flat water plate wastes the bed. Walls along shoreline, islands = separate solids, DEM nodata holes stay visible. |
